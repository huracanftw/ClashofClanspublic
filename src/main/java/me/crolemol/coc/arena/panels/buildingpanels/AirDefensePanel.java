...
public class AirDefensePanel implements BuildingPanel{
	AirDefense building;
	public AirDefensePanel(AirDefense building){
		this.building = building;
	}
	@Override
	public Inventory getInventory(){
		BuildingSpecs[] spec = building.getBuildingSpecs();
		Inventory inv2 = Bukkit.createInventory(null, 9, "Air Defense");
		ItemStack Info = new ItemStack(Material.BOOK_AND_QUILL);
		ItemMeta InfoMeta = Info.getItemMeta();
		InfoMeta.setDisplayName(ChatColor.LIGHT_PURPLE+"Info");
		List<String> list = new ArrayList<String>();
		list.add("This anti-air tower is deadly against flying enemies,");
		list.add("but can't target foes on the ground. Place it");
		list.add("wisely to cover as much airspace as possible.");
		...
		list2.add("Upgrade your Air Defense to");
		list2.add("increase its range and power!");
