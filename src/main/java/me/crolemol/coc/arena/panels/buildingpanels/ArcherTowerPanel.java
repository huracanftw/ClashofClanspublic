...
public class ArcherTowerPanel implements BuildingPanel{
	ArcherTower building;
	public ArcherTowerPanel(ArcherTower building){
		this.building = building;
	}
	@Override
	public Inventory getInventory(){
		BuildingSpecs[] spec = building.getBuildingSpecs();
		Inventory inv2 = Bukkit.createInventory(null, 9, "Archertower");
		ItemStack Info = new ItemStack(Material.BOOK_AND_QUILL);
		ItemMeta InfoMeta = Info.getItemMeta();
		InfoMeta.setDisplayName(ChatColor.LIGHT_PURPLE+"Info");
		List<String> list = new ArrayList<String>();
		list.add("Archertower are great for point defense. Upgrade Archertower to");
		...
		list2.add("Upgrade your archertowers to");
